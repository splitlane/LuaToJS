...
PRINTJ.tokenize = function(fmt/*:string*/)/*:ParsedFmt*/ {
	if(PRINTJ.tcache[fmt]) return PRINTJ.tcache[fmt];
	var out/*:ParsedFmt*/ = [];
	var start/*:number*/ = 0;
	...
	return (PRINTJ.tcache[fmt] = out);
}

PRINTJ.u_inspect/*:(o:any)=>string*/ = JSON.stringify;

PRINTJ.doit = function(t/*:ParsedFmt*/, args/*:Array<any>*/)/*:string*/ {
	//var o/*:Array<string>*/ = [];
	var o = "";
	...
	for(var i/*:number*/ = 0; i < t.length; ++i) {
		...
		switch(c) {
			...
			case /*J*/  74: O = (alt ? PRINTJ.u_inspect : JSON.stringify)(arg); break;
