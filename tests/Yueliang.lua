--[[
    Yueliang: Translate code into bytecode
...
--Order: LuaP, LuaZ, LuaU, LuaX, LuaK, LuaY, Rerubi
...
ReturnTable.LuaK = function(a) luaY = a return luaK end
...
local luaY = {}
local luaX = ReturnTable.LuaX
local luaK = ReturnTable.LuaK(luaY)
local luaP = ReturnTable.LuaP
